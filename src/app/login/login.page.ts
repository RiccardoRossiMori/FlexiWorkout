...
export class LoginPage implements OnInit {
  ...
  async login() {    // Defining login() method
    try {
      const res = await signInWithEmailAndPassword(environment.firebaseAuth,this.username + '@gmail.com', this.password+'');    // try to login with given credentials
